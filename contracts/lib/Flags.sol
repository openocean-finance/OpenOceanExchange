...
library Flags {
    ...
    uint256 internal constant FLAG_DISABLE_MDEX_BUSD = 1 << 3;
    uint256 internal constant FLAG_DISABLE_MDEX_USDC = 1 << 4;
    uint256 internal constant FLAG_DISABLE_MDEX_USDT = 1 << 5;
