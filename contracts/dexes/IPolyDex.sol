...
library IPolydexFactoryExtension {
    using SafeMath for uint256;
    using UniversalERC20 for IERC20;
    using IPolydexPairExtension for IPolydexPair;
    using Tokens for IERC20;

    function calculateSwapReturn(
        IPolydexFactory factory,
        IERC20 inToken,
        IERC20 outToken,
        ...
        IPolydexPair pair = IPolydexPair(pairAddr);
        if (pair != IPolydexPair(0)) {
